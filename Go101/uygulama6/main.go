// 1 -) 4 string elemandan oluşan bir array ve 4 int elemandan oluşna slice oluşturup index numaralarıyla birlikte gösterelim.
...
func main() {
	...
	myArr := [4]string{"kocaeli", "istanbul", "ankara", "van"}
...
// 4 -) map gösterisi ile yazar ve yazarlara ait kitapların isimlerini for range ile gösterin.
